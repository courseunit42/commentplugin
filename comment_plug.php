...
echo '<textarea type="text" name="new_comment" style="width:70%;margin-top:10px;color:#333;margin-bottom:20px;height:120px" placeholder="comments here">'.$m["comments"].'</textarea>';
}
echo '<input type="hidden" name="'.$page_level_url.'"/>';
echo '<input type="hidden" name="hash" value="'.htmlspecialchars($_GET['hash']).'"/>';
//echo '<input type="hidden" name="account_identifier" value="'.$account_identifier.'" />';
