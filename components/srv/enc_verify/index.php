...
$hash = addslashes( $_GET ['encrypt' ]);
 // Set hash variable
$search = @mysql_query( "SELECT *FROM newusers WHERE verification_hash='".$hash."' " );
...
mysql_query( "UPDATE newusers SET active='1' WHERE  verification_hash='".$hash."' AND active='0' " );

//navigate to the successful validation

$link="components/admin/Userlogin.php";

$msg="Your account has been successfully activated\r\n";
$msg.="In order to login please go here:  ".'<a href="../../admin/Userlogin.php" id="linka">to Login</a>';
$msg.="\r\nThank You".'.';
...
$header= "From: Comment Plug\r\n";
			...
			$header= "From: Comment Plug"."<noreply@commentplug.io>\r\n";
			$header.= "X-Sender: <commentPlug>\r\n";
			$header.= "X-Priority: 1\r\n";
...
$msg.='Please go to this link to <a href="../.../admin/Userlogin.php" id="linka"> Login </a> ';
$msg.='Thank You'.'<br/>';
...
$msg .='Please follow this link to <a href="../../signup.php" id="linka">Sign Up</a><br/>Thank You';
