...
<?php echo '<div class="social-sharing">'; ?>
...
<a href="http://twitter.com/danyl007O" style="color:#fff; font-family:Corbel;font-size:85%;width:70px" class="share-twitter" ><i class='fa fa-twitter fa-lg tw'></i>Twitter</a>
<a href="http://facebook.com/ibloggos" style="color:#fff;font-family:Corbel;font-size:85%;width:70px" class="share-facebook"><i class="fa fa-facebook fa-lg fb"></i>Facebook</a>
