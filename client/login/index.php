...
<title>Client Login | CommentPlug</title>
...
<div class="col-md-1"><img src="../../images/loc.jpg" width="70" height="70" class="img-responsive" alt="login"><span class="logpage" /></div>
<div class="col-md-2" style="color:#666;font-family:Corbel;font-size:12px">Client Login</div>
</div>
...
<div class="col-md-10"><input type="submit" class="btn btn-twitter" style="color:#fff;height:50px;width:140px;margin-top:5px" name="Login" value="Login" />
...
<?php echo '<span class="help-block" style="color:#ccc">'.$msg.'</div>';?>
</div>
...
$msg=$handler->loginUser($email,$password);
