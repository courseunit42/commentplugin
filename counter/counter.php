...
if((@$_SERVER['HTTP_REFERER']=='http://ibloggos.com/loginPost.php') || (@$_SERVER['HTTP_REFERER']=='http://ibloggos.com/like.php')){

	$updatecounter = mysql_query("UPDATE $dbtablehits SET count = count WHERE page = '$page'");
