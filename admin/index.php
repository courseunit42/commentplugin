...
$erroraccount='';	$errorPass='';
$erroremail='';	$errorpassword='';
$error_conf='';	$errorpaginate='';
$errorurl='';	$errorclosing='';
$errorspam='';	$errornotification='';	$errormoderate='';
...
<title>Admin Dashboard | CommentsPlug.com </title>
...
<div class="row-fluid" style="width:100%;padding:5px; -moz-border-radius:10px; -webkit-border-radius: 10px;border-radius: 10px; border: 1px solid # ccc">
...
$handler->getUnmoderatedComment(@$_SESSION['account_name']);
...
}else if($action=='paymentSettings'){
	...
	echo '<span class="help-block">Your Trial Phase Has Expired, kindly Activate your payment clicking 
	<a href="http://voguepay.com/pay" style="color:#fff;width:100px;height:35px" class="btn btn-twitter"> Here</a></span>';
